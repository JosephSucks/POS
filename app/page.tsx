...
import { TubesBackground } from '@/app/components/tubes-background'
  ...
  return (
    <TubesBackground className="min-h-screen">
      <div className="min-h-screen flex items-center justify-center p-4 pointer-events-auto">
        <Card className="w-full max-w-md bg-white/10 dark:bg-slate-900/30 backdrop-blur-xl border border-white/20 dark:border-white/10 shadow-2xl">
          <CardHeader className="space-y-2 text-center">
            ...
            <CardTitle className="text-3xl text-white">Joseph POS System</CardTitle>
            <CardDescription className="text-white/70">Enter your credentials to access the Point of Sale</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  disabled={isLoading}
                  autoFocus
                  className="bg-white/5 border-white/20 text-white placeholder:text-white/50 focus:border-emerald-500/50"
                />
              </div>
              ...
              <p className="text-xs text-center text-white/50 pt-4">
